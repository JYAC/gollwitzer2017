...
coef_lmbeta
```
Our replication yielded an unstandardized beta coefficient = 0.67.
...
Follow-up exploratory analyses revealed that pattern deviancy aversion predicted social deviancy aversion even when controlling for Need for Closure, Neuroticism and Political Orientation, F(4, 47) = 10.78, p > 0.001, R2 = .48, thereby successfully replicating the same analysis in the original paper.

The pattern deviancy aversion scale seemed to be reliable (Cronbach's alpha = 0.95). 
...
The successful replication suggests that this is a robust effect, especially since this replication yielded a stronger effect size than the original study. 
