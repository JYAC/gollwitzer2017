...
TidyData <- ExcludedData %>%
  gather(contains("Dev"), contains("Need"), contains("Neuroticism"), PoliticalOrientation, key = "Scale", value = "Rating") #Gather all scales into Scales column and all ratings into Rating column
...
TidyData$Scale[startsWith(TidyData$Scale, "Need")] <- "NeedForClosure"
...
```{r}
#Suggested in Midterm Presentation comments: See if there are order effects (whether Pattern Deviancy Aversion or Social Deviancy Aversion is measured first)
```
