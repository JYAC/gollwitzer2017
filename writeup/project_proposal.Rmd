...
TidyData <- ExcludedData %>%
  gather(starts_with("PatternDev"), key = "PatternDevItems", value = "PatternDevRating") %>%
  gather(starts_with("SocialDev"), key = "SocialDevItems", value = "SocialDevRating")%>%
  gather(starts_with("NeedForClosure"), key = "NeedforClosureItems", value = "NeedforClosureRating") %>%
  gather(starts_with("Neuroticism"), key = "NeuroticismItems", value = "NeuroticismRating")
...
OnlyKeyColumns <- TidyData %>%
  ...
  summarise(PatternDevAversion = mean(PatternDevRating), #Mean of 15 items
            ...
            PoliticalOrientation = head(PoliticalOrientation, 1)) #Same value
